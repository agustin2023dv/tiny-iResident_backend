    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('apartment', 'Apartment'), ('house', 'House')], default='apartment', max_length=20)),
                ('is_occupied', models.BooleanField(default=True)),
                ('notes', models.TextField(blank=True)),
                ('resident', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='unit', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('area_type', models.CharField(choices=[('UNIT', 'Unit'), ('COMMON_AREA', 'Common Area')], default='UNIT', max_length=20)),
                ('area_name', models.CharField(max_length=100)),
                ('job_type', models.CharField(choices=[('plumbing', 'Plumbing'), ('electrical', 'Electrical'), ('cleaning', 'Cleaning'), ('other', 'Other')], max_length=50)),
